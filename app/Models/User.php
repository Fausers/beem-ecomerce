...
class User extends Authenticatable
{
    ...
    {
        return $this->hasOne(\App\Models\Com\Cart::class);
    }

    public function addresses()
    {
        return $this->hasMany(\App\Models\Com\Address::class);
    }

    public function address()
    {
        return $this->hasOne(\App\Models\Com\Address::class)->where('status',1);
    }

    public function orders()
    {
        return $this->hasMany(\App\Models\Com\Order::class);
    }
